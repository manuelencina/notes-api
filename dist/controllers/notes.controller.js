    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, fs_1.promises.writeFile(path_1.JSON_FILE_PATH, json_converter_1.jsonConverter(notes))];
            case 2:
                _a.sent();
                res.status(201).json({
                    ok: true,
